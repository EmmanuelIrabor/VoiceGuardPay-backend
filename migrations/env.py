"""
Alembic environment. Uses DATABASE_URL_DIRECT (not the pooled URL) because
DDL/migrations should run against Neon's direct connection, not through
the pgbouncer pooler.
"""
